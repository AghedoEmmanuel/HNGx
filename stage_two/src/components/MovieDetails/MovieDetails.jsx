                        ...
                        {movie ? (
                            <>
                               ...
                               {movie.videos && playTrailer ? (
                                ...
                                <div className='md:flex md:space-x-6 items-center space-y-2'>
                                    ...
                                    <p className='flex items-center md:px-20'><img src={star} />{parseFloat(movie.vote_average).toFixed(1)}|{round(movie.vote_count)}</p>
                                </div>
